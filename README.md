![CI](https://github.com/Lucasgomespereira/CI20202/workflows/CI/badge.svg?branch=master)
...
- [x] quando enviado para o master, fazer a implantação do projeto [link](http://ci2020-lucasgomes.surge.sh/)
## Scripts Disponíveis
...
A página deverá atualizar a cada mudança.\
